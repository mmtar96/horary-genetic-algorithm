The objective of the algorithm is to generate two perfect schedules so that it is possible for teachers to teach all classes and for students to attend all classes. 
